...
def getProjectId(api_request_context: APIRequestContext):
    ...
    print("project i = ", projectId)
    return projectId

def test_createASection(api_request_context: APIRequestContext):
    # 1. get project id
    projectId = getProjectId(api_request_context)
